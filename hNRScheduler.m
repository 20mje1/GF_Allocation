classdef (Abstract) hNRScheduler < handle
    ...
    methods (Access = protected)
        ...
        function DLGrantsTTI = assignDLResourceTTI(obj, slotNum, startSym, numSym)
            ...
            eligibleUEs = getNewTxEligibleUEs(obj, obj.DLType, reTxUEs,'dl');
...
%             eligibleUEs
        ...
        function eligibleUEs = getNewTxEligibleUEs(obj, linkDir, reTxUEs, link)
            ...
            %change 1
            %here
            noReTxUEs = setdiff(getEligibleUEs(obj), reTxUEs, 'stable'); % UEs which did not get any re-Tx opportunity
            %noReTxUEs = setdiff(obj.UEs, reTxUEs, 'stable'); % UEs which did not get any re-Tx opportunity
        ...
        function eligibleUEs = getEligibleUEs(obj)
           ...
           for n=1: height(hNRSchedulerCustom.ConfiguredGrants)
           eligibleUEs(eligibleUEs == hNRSchedulerCustom.ConfiguredGrants(n,1)) = [];
           end
        end
