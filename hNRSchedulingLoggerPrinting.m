classdef hNRSchedulingLoggerPrinting < handle
            ...
            for idx = 1:min(obj.NumLogs, numel(obj.PlotIds))
                ...
                for i = stepLogStartIdx:obj.StepSize:stepLogEndIdx
                    ...
                    for j = 1 : obj.NumUEs
                      ...
                      obj.bufferSS =obj.UEsBuffStatus;
    ...
    methods( Access = private)
        ...
        function updateMetrics(obj, plotId, RBsScheduledLastStep)
            ...
            for m = 1 : obj.NumUEs
                ...
                sumBuffers=sumBuffers+obj.UEsBuffStatus(m, plotId) / 1000;
            end
              averageBuffers= (sumBuffers)/10;
                        fid = fopen('AverageBuffersWithAgent.txt', 'a+');
                        fprintf(fid, '%d\n', averageBuffers);
                        fclose(fid);
